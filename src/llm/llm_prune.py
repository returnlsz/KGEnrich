...
def llm_prune(dataset_name=None,llm=None,initial_pruning_llm="sentence-transformers",initial_pruning_topk=750,llm_pruning_topk=300,task="llm_pruning"):
    ...
    write_data_dir = f"preprocess_datasets/llm_pruning_dataset/{dataset_name}_{llm}_{initial_pruning_llm}_{initial_pruning_topk}_{llm_pruning_topk}_llm_pruning.parquet"
