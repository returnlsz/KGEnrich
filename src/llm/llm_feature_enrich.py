...
def llm_feature_enrich_main(dataset_name=None,llm=None,resume_path=None):
    return asyncio.run(llm_feature_enrich(dataset_name,llm,resume_path))

async def llm_feature_enrich(dataset_name=None,llm=None,resume_path=None):
    # 加载路径
    data_dir = '/Users/jiangtong/KnowledgeEnrich/project/preprocess_datasets/structural_enrich_dataset'
    ...
    tasks = [
        process_single_query(llm_chat, question_id, each_feature_enrich_prompt, mode)
